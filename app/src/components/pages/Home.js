                    ...
                    <div className="film-thumb">
                      ...
                      <div className="film-content">
                        ...
                        <div className="film-knoppen">
                          <Link to={`https://player.vimeo.com/video/38156752`}>
                            <i aria-hidden="true" className="fa"></i>Trailer
                          </Link>
                          <Link
                            to={`http://demo.amytheme.com/movie/demo/single-cinema/amy_movie/star-trek-beyond/`}>
                            <i aria-hidden="true" className="fa"></i>Detail
                          </Link>
                        </div>
                      </div>
                      <div className="pic-caption left-info">
                        ...
                        <span className="pg">18 +</span>
                        <div className="desc-mv">
                          <p>
                            <span>Uitgebracht: </span>Augustus 3, 2020
                          </p>
                          <p>
                            <span>Genre: </span>
                          ...
                          <p>
                            <span>Duur: </span>01 uur 20 minuten
                          </p>
                          <p>
                            <span>Taal: </span>Engels
                          </p>
                        </div>
                        <span className="rate">4</span>
                        <div className="entry-button">
                          <Link
                            to={`https://player.vimeo.com/video/38156752`}
                            className="fancybox.iframe amy-fancybox">
                            <i aria-hidden="true" className="fa"></i>Trailer
                          </Link>
                          <Link
                            to={`http://demo.amytheme.com/movie/demo/single-cinema/amy_movie/star-trek-beyond/`}>
                  ...
                  <article className="film-item" onclick={console.log("hoi")}>
                    <div className="film-thumb">
                      ...
                      <div className="pic-caption left-info">
                        ...
                        <div className="entry-button">
                          <Link
                            to={`https://player.vimeo.com/video/38156752" className="fancybox.iframe amy-fancybox`}>
                            <i aria-hidden="true" className="fa"></i>Trailer
                          </Link>
                          <Link
                            to={`http://demo.amytheme.com/movie/demo/single-cinema/amy_movie/star-trek-beyond/`}>
                    ...
                    <div className="wpb_wrapper">
                      <div className="wpb_text_column wpb_content_element ">
                        <div className="wpb_wrapper">
                          <ul>
                            <li>
                              <Link to={`#`}>Locaties</Link>
                            </li>
                            <li>
                              <Link to={`#`}>Aanbiedingen</Link>
                            </li>
                            <li>
                              <Link to={`#`}>Koop tickets</Link>
                            </li>
                            <li>
                              <Link to={`#`}>Stel een vraag</Link>
                            </li>
                          </ul>
                        </div>
                      </div>
